...
namespace WebsiteE_Commerce.Controllers
{
    public class HangHoaController : Controller
    {
        ...
        public HangHoaController(QuanLyHangHoaContext context)
        {
            _context = context;
        }
        ...
        {
            var quanLyHangHoaContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await quanLyHangHoaContext.ToListAsync());
        }
